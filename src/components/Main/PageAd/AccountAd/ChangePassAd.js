...
export default function ChangePassAd({ navigation, route }) {
  ...
  function changepassad() {
    if (mkn !== mkc || !mk || !mkc || !mkn) {
      Alert.alert('Thông báo', 'Vui lòng nhập lại');
    } else {
      fetch('http://192.168.195.111:80/WebAPI/public/changepassadmin', {
        method: 'POST',
        headers: {
